...
print("channel,coins,from,gender,practiceTime,videoTime,level,name,nickname,phone,points,publisher,semester,role,scores,type,registDate,VIPendDate")
db.users.aggregate(
    {"$project": {
    ...
    function(doc) {
        print(doc.channel + "," + doc.coins + "," + doc.from + "," +
